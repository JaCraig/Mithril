...
namespace Mithril.Core.Abstractions.Data.BaseClasses
{
        ...
        where TClass : TypedModelBase<TClass>, new()
    {
        ...
        public static bool operator !=(TypedModelBase<TClass>? left, TypedModelBase<TClass>? right)
        {
            return !(left == right);
        }
        ...
        {
            return (other is TypedModelBase<TClass> TempObject) && CompareTo(TempObject) == 0;
        }
        ...
        /// parameter; otherwise, false.
        /// </returns>
        public bool Equals(TypedModelBase<TClass>? other)
        {
        ...
        {
            return (obj is TypedModelBase<TClass> TempObject) && Equals(TempObject);
        }
        ...
        public bool OfType(params string?[]? typeNames)
        {
            if (string.IsNullOrEmpty(Type) || typeNames is null)
                return false;
