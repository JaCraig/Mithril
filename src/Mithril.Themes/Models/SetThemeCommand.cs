...
namespace Mithril.Themes.Models
{
    ...
    /// Set theme command
    /// </summary>
    /// <seealso cref="CommandBaseClass&lt;SetThemeCommand&gt;"/>
    public class SetThemeCommand : CommandBaseClass<SetThemeCommand>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SetThemeCommand"/> class.
        /// </summary>
        ...
        public SetThemeCommand(string? themeName)
        {
            ThemeName = themeName;
        }
