...
namespace Mithril.Communication.Email.Models
{
    ...
    public class EmailMessage : ModelBase<EmailMessage>, IMessage
    {
        ...
        public static bool operator !=(EmailMessage left, EmailMessage right) => !(left == right);
        ...
        /// <param name="right">The right.</param>
        /// <returns>The result of the operator.</returns>
        public static bool operator <(EmailMessage left, EmailMessage right) => left is null ? right is null : left.CompareTo(right) < 0;
        ...
        /// <returns>The result of the operator.</returns>
        public static bool operator ==(EmailMessage first, EmailMessage second) => ReferenceEquals(first, second) || (first is not null && second is not null && first.CompareTo(second) == 0);
        ...
        public override int CompareTo(EmailMessage? other) => base.CompareTo(other);
        ...
        /// </returns>
        public bool Equals(EmailMessage other) => base.Equals(other);
