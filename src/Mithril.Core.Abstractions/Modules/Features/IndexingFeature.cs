...
namespace Mithril.Core.Abstractions.Modules.Features
{
    ...
    /// Indexing feature
    /// </summary>
    /// <seealso cref="FeatureBaseClass{IndexingFeature}"/>
    public class IndexingFeature : FeatureBaseClass<IndexingFeature>
    {
        /// <summary>
        ...
        public override string Description { get; } = "Allows indexing and searching of content";

        /// <summary>
        /// Human-readable name of the feature. If not provided, the identifier will be used.
        /// </summary>
        /// <value>The name.</value>
        public override string Name { get; } = "Indexing";
    }
}