...
namespace Mithril.Apm.Default.Models
{
    ...
    public class RequestMetaData : ModelBase<RequestMetaData>
    {
        ...
        public static bool operator !=(RequestMetaData left, RequestMetaData right) => !(left == right);
        ...
        /// <param name="right">The right.</param>
        /// <returns>The result of the operator.</returns>
        public static bool operator <(RequestMetaData left, RequestMetaData right) => left is null ? right is null : left.CompareTo(right) < 0;
        ...
        public override int CompareTo(RequestMetaData? other) => base.CompareTo(other);
        ...
        /// </returns>
        public bool Equals(RequestMetaData other) => base.Equals(other);
        ...
        public override string ToString() => (DisplayName ?? "") + ": " + MetaData;
    }
}