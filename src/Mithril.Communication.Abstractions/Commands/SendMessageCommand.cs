...
namespace Mithril.Communication.Abstractions.Commands
{
    ...
    public class SendMessageCommand : CommandBaseClass<SendMessageCommand>
    {
        ...
        public static bool operator !=(SendMessageCommand left, SendMessageCommand right)
        {
            return !(left == right);
        }
        ...
        /// <returns>The result of the operator.</returns>
        public static bool operator ==(SendMessageCommand first, SendMessageCommand second)
        {
        ...
        public override int CompareTo(SendMessageCommand? other)
        {
