...
const Sa = /* @__PURE__ */ $(ga, [["render", ba]]), $a = y.defineComponent({
  ...
  Ma
], Ea = /* @__PURE__ */ l("th", null, null, -1), Ta = ["onClick"], Ca = ["colspan"];
function Fa(e, t, a, n, o, c) {
  return r(), s("div", null, [
...
const qa = /* @__PURE__ */ $($a, [["render", Fa]]), Ia = y.defineComponent({
  methods: {
    findTab: function(e) {
...
}), ja = { class: "tabs" }, Va = { class: "row flex align-items-stretch" }, Aa = ["onClick"];
function Oa(e, t, a, n, o, c) {
  return r(), s("div", ja, [
    l("header", null, [
      l("ul", Va, [
...
const Na = /* @__PURE__ */ $(Ia, [["render", Oa]]), La = y.defineComponent({
  components: {
    tabs: Na
  },
  data() {
...
const Ba = /* @__PURE__ */ $(La, [["render", Pa]]), Ra = y.defineComponent({
  data: function() {
    let e = {};
...
const Ya = /* @__PURE__ */ $(Ra, [["render", Ua]]), _a = y.defineComponent({
  name: "form-field-complex",
  components: {
    "form-field-complex-conditional": Sa,
    "form-field-complex-list": qa,
    "form-field-complex-tabs": Ba,
    "form-field-input": re,
    "form-field-select": se,
    "form-field-checkbox": oe,
    "form-field-radio": le,
    ...
    "form-field-upload": ue,
    "form-field-buttons": he,
    "form-field-complex-repeater": Ya
  },
  data: function() {
    return {
      internalModel: this.model,
...
const Ga = /* @__PURE__ */ $(_a, [["render", Ka]]), Ha = y.defineComponent({
  name: "mithril-form",
  components: {
    "form-field-complex": Ga
  },
  data: function() {
    return {
      submitting: !1,
...
const U = (e) => (B("data-v-c5bd6270"), e = e(), R(), e), Qa = ["action", "enctype", "id"], Ja = {
  key: 0,
  class: "panel error"
}, Wa = /* @__PURE__ */ U(() => /* @__PURE__ */ l("header", null, "Oops, some form elements have problems", -1)), Za = /* @__PURE__ */ U(() => /* @__PURE__ */ l("div", { class: "body" }, " We're sorry but some of the fields are having issues. ", -1)), Xa = [
  Wa,
  Za
], xa = { class: "input-group" }, en = ["disabled", "value"], tn = ["disabled"], an = {
  key: 1,
  class: "flex row no-wrap"
}, nn = { class: "panel" }, rn = /* @__PURE__ */ U(() => /* @__PURE__ */ l("header", null, "Form Schema", -1)), sn = { class: "body" }, on = { class: "panel" }, ln = /* @__PURE__ */ U(() => /* @__PURE__ */ l("header", null, "Form Model", -1)), dn = { class: "body" };
function cn(e, t, a, n, o, c) {
...
const me = /* @__PURE__ */ $(Ha, [["render", cn], ["__scopeId", "data-v-c5bd6270"]]), un = y.defineComponent({
  ...
  key: 0,
  class: "panel debug"
}, fn = /* @__PURE__ */ l("header", null, "Editor Schema", -1);
function pn(e, t, a, n, o, c) {
...
const gn = /* @__PURE__ */ $(un, [["render", pn]]);
class fe {
  // Constructor
...
const W = (e) => (B("data-v-f557b045"), e = e(), R(), e), bn = { class: "flex row" }, Sn = { class: "right" }, $n = /* @__PURE__ */ Me('<option value="10" data-v-f557b045>10</option><option value="25" data-v-f557b045>25</option><option value="50" data-v-f557b045>50</option><option value="100" data-v-f557b045>100</option><option value="-1" data-v-f557b045>All</option>', 5), vn = [
  $n
], kn = /* @__PURE__ */ W(() => /* @__PURE__ */ l("br", { class: "clear" }, null, -1)), wn = ["onClick"], Mn = {
  key: 0,
  class: "flex row"
}, Dn = { class: "panel" }, En = /* @__PURE__ */ W(() => /* @__PURE__ */ l("header", null, "Listing Schema", -1)), Tn = { class: "body" }, Cn = { class: "panel" }, Fn = /* @__PURE__ */ W(() => /* @__PURE__ */ l("header", null, "Listing Model", -1)), qn = { class: "body" };
function In(e, t, a, n, o, c) {
  return r(), s("div", null, [
    l("div", bn, [
      j(l("input", {
        type: "text",
...
const jn = /* @__PURE__ */ $(yn, [["render", In], ["__scopeId", "data-v-f557b045"]]), Vn = y.defineComponent({
...
const Z = (e) => (B("data-v-c4c98bca"), e = e(), R(), e), An = ["title"], On = /* @__PURE__ */ Z(() => /* @__PURE__ */ l("span", { class: "fas fa-plus right" }, null, -1)), Nn = [
  On
], Ln = /* @__PURE__ */ Z(() => /* @__PURE__ */ l("span", { class: "fas fa-list right" }, null, -1)), Pn = [
  Ln
], Bn = { class: "body" }, Rn = { key: 0 }, zn = { key: 1 }, Un = {
  key: 2,
  class: "panel debug"
}, Yn = /* @__PURE__ */ Z(() => /* @__PURE__ */ l("header", null, "Editor Schema", -1));
function _n(e, t, a, n, o, c) {
...
const Kn = /* @__PURE__ */ $(Vn, [["render", _n], ["__scopeId", "data-v-c4c98bca"]]), Gn = y.defineComponent({
...
const Hn = (e) => (B("data-v-280d2014"), e = e(), R(), e), Qn = { class: "main-application" }, Jn = { class: "left-nav panel" }, Wn = { class: "menu" }, Zn = ["onClick", "title"], Xn = { class: "editor-content" }, xn = {
  key: 1,
  class: "panel debug"
}, ei = /* @__PURE__ */ Hn(() => /* @__PURE__ */ l("header", null, "Selected Editor Info", -1));
function ti(e, t, a, n, o, c) {
  return r(), s("div", Qn, [
    l("div", Jn, [
    ...
    l("div", Xn, [
      ...
      e.debug && e.currentEditor ? (r(), s("div", xn, [
        ei,
        l("ul", null, [
...
const ai = /* @__PURE__ */ $(Gn, [["render", ti], ["__scopeId", "data-v-280d2014"]]);
let E = {
...
const oi = /* @__PURE__ */ $(ri, [["render", si]]), li = y.defineComponent({
  data: function() {
    return {
      items: this.items,
      showDropDown: !1
...
}), di = { class: "unstyled" }, ci = { class: "grouped" }, ui = ["href"];
function hi(e, t, a, n, o, c) {
...
const mi = /* @__PURE__ */ $(li, [["render", hi]]), fi = (e) => {
  e.component("mithril-data-handler", oi), e.component("mithril-side-menu", mi);
}, pi = {
  install: (e, t) => {
    ii(e), ni(e), fi(e);
  }
...
class gi {
  ...
  SetupComponents(t) {
    return t.use(pi), t.component("admin-application", ai), t.component("settings-editor-component", gn), t.component("data-editor-component", Kn), t;
  }
}
const $i = (() => {
  new gi();
