...
}`}).onSuccess(n=>{e.editors=n.data.editors,e.debug&&d.debug("Finished loading editors:",n.data.editors)}).withStorageMode($.StorageAndUpdate).send()}},props:{debug:{type:Boolean,default:!0}},created:function(){this.loadEditors()}}),Za="",ma=e=>(t.pushScopeId("data-v-280d2014"),e=e(),t.popScopeId(),e),ha={class:"main-application"},pa={class:"left-nav panel"},fa={class:"menu"},ua=["onClick","title"],ga={class:"editor-content"},ya={key:1,class:"panel debug"},ka=ma(()=>t.createElementVNode("header",null,"Selected Editor Info",-1));function Sa(e,n,a,r,o,s){return t.openBlock(),t.createElementBlock("div",ha,[t.createElementVNode("div",pa,[(t.openBlock(!0),t.createElementBlock(t.Fragment,null,t.renderList(e.groupedEditors,i=>(t.openBlock(),t.createElementBlock("section",{key:i.category},[t.createElementVNode("header",null,t.toDisplayString(e.$filters.capitalize(i.category)),1),t.createElementVNode("ul",fa,[(t.openBlock(!0),t.createElementBlock(t.Fragment,null,t.renderList(i.editors,(l,c)=>(t.openBlock(),t.createElementBlock("li",{key:l.name},[t.createElementVNode("a",{href:"#!",onClick:t.withModifiers(m=>e.editorSelected(l),["stop","prevent"]),title:l.description,class:t.normalizeClass({selected:e.currentEditor==l})},[t.createElementVNode("span",{class:t.normalizeClass(l.icon)},null,2),t.createTextVNode(t.toDisplayString(l.name),1)],10,ua)]))),128))])]))),128))]),t.createElementVNode("div",ga,[e.currentEditor?(t.openBlock(),t.createBlock(t.resolveDynamicComponent(e.currentEditor.componentDefinition.schema.type),{key:0,schema:e.currentEditor.componentDefinition.schema,name:e.currentEditor.name,debug:e.debug,onError:e.error,onClose:e.close},null,40,["schema","name","debug","onError","onClose"])):t.createCommentVNode("",!0),e.debug&&e.currentEditor?(t.openBlock(),t.createElementBlock("div",ya,[ka,t.createElementVNode("ul",null,[t.createElementVNode("li",null," Component Name: "+t.toDisplayString(e.currentEditor.componentDefinition.name),1),t.createElementVNode("li",null," Component Type: "+t.toDisplayString(e.currentEditor.componentDefinition.schema.type),1)])])):t.createCommentVNode("",!0)])])}const ba=h(da,[["render",Sa],["__scopeId","data-v-280d2014"]]);let y={mounted:function(e,n){if(y.onEventBound=y.onEvent.bind({el:e}),document.addEventListener("click",y.onEventBound),typeof n.value!="function")throw new Error("Argument must be a function");y.cb=n.value},cb:function(e){},onEvent:function(e){e.target===this.el||this.el.contains(e.target)||!y.cb||y.cb(e)},onEventBound:function(){},unbind:function(){document.removeEventListener("click",y.onEventBound)},update:function(e,n){if(typeof n.value!="function")throw new Error("Argument must be a function");y.cb=n.value}};function Ea(e){return e.directive("click-outside",y),e}function $a(e){return e==null||(e.config.globalProperties.$filters={moment:function(n,a,r){return n==null?"N/A":(r??(r="YYYY-MM-DDThh:mm:ss"),a??(a="M-D-YYYY h:mm A"),f(n,r).format(a))},capitalize:function(n){return n==null?"":n.charAt(0).toUpperCase()+n.slice(1)},maxsize:function(n,a,r){return n==null?"":n.length<=a?n:(r??(r="..."),n.substring(0,a)+r)},currency:function(n,a,r){return n==null?"":(a??(a="en-US"),r??(r={style:"currency",currency:"USD"}),Intl.NumberFormat(a,r).format(n))}}),e}class Q{}const va=t.defineComponent({name:"DataHandler",data:function(){return{count:0,timer:0,internalData:this.model}},props:{model:{type:Object,default:{}},schema:{type:Q,default:new Q}},methods:{fetchData:function(){if(!this.schema.loadUrl)return;let e=this;p.post("/api/query",{query:e.schema.datalistQuery}).onSuccess(n=>{e.schema.datalist=n.data.dropDown}).withStorageMode($.StorageAndUpdate).send()},saveData:function(){},deleteData:function(){}},created:function(){if(!this.schema.datalistQuery)return;this.fetchData()},watch:{model:function(e,n){n!==e&&(this.internalModel=e)}}});function wa(e,n,a,r,o,s){return t.openBlock(),t.createElementBlock("div",null,[t.createTextVNode(" ASDF "),(t.openBlock(!0),t.createElementBlock(t.Fragment,null,t.renderList(e.schema.children,i=>(t.openBlock(),t.createBlock(t.resolveDynamicComponent(i.type),{key:i.type,data:e.internalData,schema:i,onSave:e.saveData,onDelete:e.deleteData,onLoad:e.fetchData},null,40,["data","schema","onSave","onDelete","onLoad"]))),128)),t.createElementVNode("pre",null,t.toDisplayString(e.internalData),1)])}const Ba=h(va,[["render",wa]]),Na=t.defineComponent({data:function(){return{items:this.items,showDropDown:!1}},props:{items:Array},methods:{showDropDownFunc:function(){this.showDropDown=!0},hideDropDownFunc:function(){this.showDropDown=!1}},directives:{clickOutside:y}}),Ca={class:"unstyled"},Ma={class:"grouped"},Da=["href"];function Ta(e,n,a,r,o,s){const i=t.resolveDirective("click-outside");return t.withDirectives((t.openBlock(),t.createElementBlock("ul",Ca,[t.createElementVNode("li",null,[t.createElementVNode("a",{class:"fas fa-circle-user",href:"#",onClick:n[0]||(n[0]=t.withModifiers((...l)=>e.showDropDownFunc&&e.showDropDownFunc(...l),["stop","prevent"]))}),t.createElementVNode("div",{class:t.normalizeClass({show:e.showDropDown,"z-depth-2":e.showDropDown,hidden:!e.showDropDown})},[t.createElementVNode("ul",Ma,[(t.openBlock(!0),t.createElementBlock(t.Fragment,null,t.renderList(e.items,l=>(t.openBlock(),t.createElementBlock("li",{key:l.display},[t.createElementVNode("a",{href:l.url,class:t.normalizeClass([l.icon])},t.toDisplayString(l.display),11,Da)]))),128))])],2)])])),[[i,e.hideDropDownFunc]])}const Fa=h(Na,[["render",Ta]]),qa=e=>{e.component("mithril-data-handler",Ba),e.component("mithril-side-menu",Fa)},Ia={install:(e,n)=>{$a(e),Ea(e),qa(e)}};class ja{constructor(){Z(this,"AdminApp");d.debug("Admin loading"),this.AdminApp=this.SetupComponents(t.createApp({data:function(){return{}}})),this.AdminApp.mount("#AdminApplication"),d.debug("Admin loaded")}SetupComponents(n){return n.use(Ia),n.component("admin-application",ba),n.component("settings-editor-component",On),n.component("data-editor-component",ca),n}}return(()=>{new ja})()});
